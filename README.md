...
To map the RNAseq reads, we utilized a _C. Albicans_ reference genome downloaded from NCBI (GCF_000182965.3). This reference genome was indexed using Bowtie2 to generate an indexed map, and then aligned against that map.
